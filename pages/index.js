      ...
      <div className="bg-zinc-800 p-2 mx-6 rounded-2xl">
        ...
        <div className="flex flex-col md:flex-row rounded-l-xl">
          ...
          <img
            src="img/image.jpg"
            alt="image"
            className="object-fit rounded-xl h-80 md:h-64 md:rounded-l-xl md:rounded-r-none transform hover:scale-105 hover:rounded-xl duration-200 hover:md:rounded-r-none"
          />
          {/* Content */}
          <div className="p-6 md:p-12">
            ...
            <p className="max-w-xs my-4 text-xs leading-5 tracking-wider text-center text-white md:text-left">
